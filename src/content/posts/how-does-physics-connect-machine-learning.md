...
<iframe title="Interactive plot: Ising model magnetization versus temperature" width="100%" height="800" frameborder="0" scrolling="no" src="/files/ising_model_magnetization.html"></iframe>
...
*Anything to add or fix in this article to reduce confusion and increase clarity? Please [email me](mailto:j@jaan.io), [tweet](https://twitter.com/thejaan), or [submit a pull request](https://github.com/altosaar/jaan.io/blob/master/_posts/blog/2017-08-11-how-does-physics-connect-machine-learning.md).*
