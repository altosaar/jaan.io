...
export const SITE = {
  ...
  features: {
     ...
     * set on a 98-second loop, so the mark is slowly dissolving from one face
     * into the next. Generated by scripts/gen-favicons.mjs.
     *
     ...
     *
     * The 1024px figure lives in two places that must agree: the @media block
     * in chrome.css that reveals it, and the desktop <source> in
     * SiteHeader.astro that keeps desktop from downloading it. Both carry a
     * comment pointing here and at each other.
     */
    navMorph: true,
  },
} as const;
